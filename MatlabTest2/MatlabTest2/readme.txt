testEx MATLAB .NET Assembly (.NET Component)
...
testEx_overview.html - HTML overview documentation file for the generated component. It 
                       contains the requirements for accessing the component and for 
                       generating arguments using the MWArray class hierarchy.

testEx.xml - This file contains the code comments for the testEx component classes and 
                       ...
                       online documentation for the testEx component.
