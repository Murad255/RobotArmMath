...
* isck\ãçñ¡ _online\SIENCE\Simulation_matlab\robotDraw\for_testing""-v""class{Robot:G:\Goo
* gleDisck\ãçñ¡ _online\SIENCE\Simulation_matlab\robot_arm.m}"
*/
using System;
...
namespace robot_arm
{
  ...
  /// <summary>
  /// The Robot class provides a CLS compliant, MWArray interface to the MATLAB functions
