kinematicMArm MATLAB .NET Assembly (.NET Component)
...
kinematicMArm_overview.html - HTML overview documentation file for the generated 
                              component. It contains the requirements for accessing the 
                              component and for generating arguments using the MWArray 
                              class hierarchy.

kinematicMArm.xml - This file contains the code comments for the kinematicMArm component 
