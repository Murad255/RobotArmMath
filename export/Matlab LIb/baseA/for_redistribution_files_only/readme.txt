baseA MATLAB .NET Assembly (.NET Component)
...
baseA_overview.html - HTML overview documentation file for the generated component. It 
                      contains the requirements for accessing the component and for 
                      generating arguments using the MWArray class hierarchy.

baseA.xml - This file contains the code comments for the baseA component classes and 
                      ...
                      online documentation for the baseA component.
